 ...
 */
final class Version20231205194737 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE report_postes (report_id INT NOT NULL, postes_id INT NOT NULL, INDEX IDX_7385E9FB4BD2A4C0 (report_id), INDEX IDX_7385E9FBE30A0B60 (postes_id), PRIMARY KEY(report_id, postes_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
